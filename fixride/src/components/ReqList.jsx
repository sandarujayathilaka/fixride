...
const ReqList = () => {
  ...
  const handleClickAssign = () => {
    if (data[selectedItemIndex].id) {
      ...
      //   },
      // });
      navigation.navigate("MacList", { Id: data[selectedItemIndex].id });
    } else {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.button2} onPress={handleOngoingClick}>
            ...
            <View style={styles.cardContent}>
              <View style={{ flexDirection: "column" }}>
                <Text style={styles.cardText}>
                  Vehicle Model:{" "}
                  <Text style={styles.value}>{item.vehicleModel}</Text>
                </Text>
                <Text style={styles.cardText}>
                  Vehicle Number:
                ...
                <Text style={styles.cardText}>
                  Power Source:{" "}
                  <Text style={styles.value}>{item.powerSource}</Text>
                </Text>
              </View>
            </View>
            <TouchableOpacity
            ...
            {selectedItem && (
              <View>
                ...
                <View style={styles.modelCard}>
                  <Text>
                    Name:{" "}
                    <Text style={styles.subTitle}>{selectedItem.username}</Text>
                  </Text>
                  <Text>
                    Mobile Number:{" "}
